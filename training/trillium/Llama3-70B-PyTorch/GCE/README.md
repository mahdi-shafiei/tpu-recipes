...
Note: if want to get metric printed on all workers, please try `us-central1-docker.pkg.dev/deeplearning-images/reproducibility/pytorch-xla/llama3-70b:jan15built` by modifying [this line](https://github.com/AI-Hypercomputer/tpu-recipes/blob/af4393a42966a9a1f76b9f270a2e07788e2879ff/training/trillium/Llama3-70B-PyTorch/GCE/host.sh#L3)
